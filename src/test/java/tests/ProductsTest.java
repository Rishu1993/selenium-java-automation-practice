...
public class ProductsTest extends BaseTest {
	...
	@Test(description = "Navigate to url add product verify and checkout",retryAnalyzer = utils.RetryAnalyzer.class)
	...
	public void clickProductsTest() throws InterruptedException {
		...
		PaymentPage paymnet = new PaymentPage(driver);
		paymnet.enterNameOncard("");
		String validationMsg = paymnet.clickConfirmOrder();
